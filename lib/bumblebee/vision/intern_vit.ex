defmodule Bumblebee.Vision.InternVit do
  ...
  options =
    [
      ...
      use_qk_norm: [
        default: true,
        doc: "whether to apply normalization to query and key in self-attention"
      ],
  ...
  @moduledoc """
  The InternViT model for image encoding.
  ...
  defp core(inputs, spec) do
    ...
    pooled_state =
      Layers.take_token(encoder_outputs.hidden_state, index: 0, axis: 1)
  ...
  defimpl Bumblebee.HuggingFace.Transformers.Config do
    # Support loading from the entire InternVL configuration
    def load(spec, %{"model_type" => "intern_vit_6b", "vision_config" => data}) do
      load(spec, data)
    end
    ...
    def load(spec, data) do
      ...
      opts =
        convert!(data,
          ...
          use_qk_norm: {"qk_normalization", boolean()},
  ...
  defimpl Bumblebee.HuggingFace.Transformers.Model do
    def params_mapping(_spec) do
      %{
        ...
        "encoder.blocks.{n}.self_attention_norm" => "vision_model.encoder.layers.{n}.norm1",
        "encoder.blocks.{n}.self_attention.query" =>
          "vision_model.encoder.layers.{n}.attn.q_proj",
        "encoder.blocks.{n}.self_attention.key" =>
          "vision_model.encoder.layers.{n}.attn.k_proj",
        "encoder.blocks.{n}.self_attention.value" =>
          "vision_model.encoder.layers.{n}.attn.v_proj",
        "encoder.blocks.{n}.self_attention.output" =>
          "vision_model.encoder.layers.{n}.attn.out_proj",
        ...
        "encoder.blocks.{n}.output_norm" => "vision_model.encoder.layers.{n}.norm2"
      }
    end
  end
end
