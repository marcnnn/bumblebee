defmodule Bumblebee.Vision.SwinV2 do
  ...
  ## Architectures
    ...
    * `:base` - plain SwinV2 without any head on top

    * `:for_image_classification` - SwinV2 transformer model with a
      classification head
  ...
  defp transformer_block(hidden_state, opts) do
    ...
    # SwinV2 uses log-spaced continuous position bias instead of a
    # learned relative position bias table
    relative_attention_bias =
      log_spaced_continuous_position_bias(window_size, num_attention_heads,
        name: join(name, "self_attention.logit_scale_and_cpb")
      )
  ...
  defp log_spaced_continuous_position_bias(window_size, num_attention_heads, opts) do
    name = opts[:name]

    # SwinV2 replaces the parameterized relative position bias table
    # with a log-spaced continuous position bias generated by a small
    # MLP. We precompute the relative coordinate table and feed it
    # through a 2-layer MLP to produce the bias.
  ...
  defimpl Bumblebee.HuggingFace.Transformers.Model do
    def params_mapping(_spec) do
      %{
        ...
        "embedder.norm" => "swinv2.embeddings.norm",
        "encoder.stages.{n}.blocks.{m}.output_norm" =>
          "swinv2.encoder.layers.{n}.blocks.{m}.layernorm_after",
        "encoder.stages.{n}.blocks.{m}.self_attention_norm" =>
          "swinv2.encoder.layers.{n}.blocks.{m}.layernorm_before",
        "encoder.stages.{n}.blocks.{m}.self_attention.key" =>
          "swinv2.encoder.layers.{n}.blocks.{m}.attention.self.key",
        "encoder.stages.{n}.blocks.{m}.self_attention.output" =>
          "swinv2.encoder.layers.{n}.blocks.{m}.attention.output.dense",
        "encoder.stages.{n}.blocks.{m}.self_attention.query" =>
          "swinv2.encoder.layers.{n}.blocks.{m}.attention.self.query",
        "encoder.stages.{n}.blocks.{m}.self_attention.value" =>
          "swinv2.encoder.layers.{n}.blocks.{m}.attention.self.value",
        "encoder.stages.{n}.blocks.{m}.self_attention.logit_scale_and_cpb" => %{
          "kernel" => {
            [
              {"swinv2.encoder.layers.{n}.blocks.{m}.attention.self",
        ...
        "encoder.stages.{n}.blocks.{m}.ffn.intermediate" =>
          "swinv2.encoder.layers.{n}.blocks.{m}.intermediate.dense",
        "encoder.stages.{n}.blocks.{m}.ffn.output" =>
          "swinv2.encoder.layers.{n}.blocks.{m}.output.dense",
        "encoder.stages.{n}.downsample.norm" => "swinv2.encoder.layers.{n}.downsample.norm",
        "encoder.stages.{n}.downsample.reduction" =>
          "swinv2.encoder.layers.{n}.downsample.reduction",
        "norm" => "swinv2.layernorm",
