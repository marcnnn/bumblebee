defmodule Bumblebee.Audio.Hubert do
  ...
  ## Architectures
    ...
    * `:base` - plain HuBERT without any head on top

    * `:for_ctc` - HuBERT with a CTC (Connectionist Temporal Classification)
      head for speech recognition. The head returns logits for each frame
      in the input sequence

    * `:for_sequence_classification` - HuBERT with a sequence
  ...
  defimpl Bumblebee.HuggingFace.Transformers.Model do
    def params_mapping(_spec) do
      %{
        "feature_extractor.conv.0" => "hubert.feature_extractor.conv_layers.0.conv",
        "feature_extractor.conv.1" => "hubert.feature_extractor.conv_layers.1.conv",
        "feature_extractor.conv.2" => "hubert.feature_extractor.conv_layers.2.conv",
        "feature_extractor.conv.3" => "hubert.feature_extractor.conv_layers.3.conv",
        "feature_extractor.conv.4" => "hubert.feature_extractor.conv_layers.4.conv",
        "feature_extractor.conv.5" => "hubert.feature_extractor.conv_layers.5.conv",
        "feature_extractor.conv.6" => "hubert.feature_extractor.conv_layers.6.conv",
        ...
        "feature_extractor.layer_norm.1" =>
          "hubert.feature_extractor.conv_layers.1.layer_norm",
        "feature_extractor.layer_norm.2" =>
          "hubert.feature_extractor.conv_layers.2.layer_norm",
        "feature_extractor.layer_norm.3" =>
          "hubert.feature_extractor.conv_layers.3.layer_norm",
        "feature_extractor.layer_norm.4" =>
          "hubert.feature_extractor.conv_layers.4.layer_norm",
        "feature_extractor.layer_norm.5" =>
          "hubert.feature_extractor.conv_layers.5.layer_norm",
        "feature_extractor.layer_norm.6" =>
          "hubert.feature_extractor.conv_layers.6.layer_norm",
        "feature_projection.norm" => "hubert.feature_projection.layer_norm",
        "feature_projection.projection" => "hubert.feature_projection.projection",
        "encoder.pos_conv.norm" => "hubert.encoder.layer_norm",
        "encoder.blocks.{n}.self_attention.query" =>
          "hubert.encoder.layers.{n}.attention.q_proj",
        "encoder.blocks.{n}.self_attention.key" =>
          "hubert.encoder.layers.{n}.attention.k_proj",
        "encoder.blocks.{n}.self_attention.value" =>
          "hubert.encoder.layers.{n}.attention.v_proj",
        "encoder.blocks.{n}.self_attention.output" =>
          "hubert.encoder.layers.{n}.attention.out_proj",
        "encoder.blocks.{n}.self_attention_norm" =>
          "hubert.encoder.layers.{n}.layer_norm",
        "encoder.blocks.{n}.ffn.intermediate" =>
          "hubert.encoder.layers.{n}.feed_forward.intermediate_dense",
        "encoder.blocks.{n}.ffn.output" =>
          "hubert.encoder.layers.{n}.feed_forward.output_dense",
        "encoder.blocks.{n}.output_norm" =>
          "hubert.encoder.layers.{n}.final_layer_norm",
