defmodule Bumblebee.Audio.Bark do
  ...
  ## Architectures
    ...
    * `:base` - plain Bark without any head on top

    * `:for_causal_language_modeling` - Bark with a language modeling
    ...
    def load(spec, data) do
      ...
      opts =
        convert!(data,
          ...
          intermediate_size: {"n_inner", number()},
  ...
  defimpl Bumblebee.HuggingFace.Transformers.Model do
    def params_mapping(_spec) do
      %{
        "embedder.token_embedding" => "model.wte",
        "embedder.position_embedding" => "model.wpe",
        ...
        "decoder.blocks.{n}.self_attention.output" => "model.layers.{n}.attn.out_proj",
        "decoder.blocks.{n}.self_attention_norm" => "model.layers.{n}.ln_1",
        "decoder.blocks.{n}.ffn.intermediate" => "model.layers.{n}.mlp.c_fc",
        "decoder.blocks.{n}.ffn.output" => "model.layers.{n}.mlp.c_proj",
        "decoder.blocks.{n}.output_norm" => "model.layers.{n}.ln_2",
        "norm" => "model.ln_f",
