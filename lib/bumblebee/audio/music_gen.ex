defmodule Bumblebee.Audio.MusicGen do
  ...
  @moduledoc """
  MusicGen model family.

  ## Architectures

    * `:base` - plain MusicGen without any head on top

    * `:for_conditional_generation` - MusicGen with a language modeling
