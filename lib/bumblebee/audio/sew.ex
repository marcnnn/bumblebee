defmodule Bumblebee.Audio.Sew do
  ...
  options =
    [
      ...
      squeeze_factor: [
        default: 2,
        doc: "the squeeze factor for the feature extractor output length reduction"
      ],
  ...
  ## Architectures
    ...
    * `:base` - plain SEW without any head on top

    * `:for_ctc` - SEW with a CTC (Connectionist Temporal Classification)
      head for speech recognition. The head returns logits for each frame
      in the input sequence

    * `:for_sequence_classification` - SEW with a sequence
    ...
    def load(spec, data) do
      ...
      opts =
        convert!(data,
          ...
          squeeze_factor: {"squeeze_factor", number()},
  ...
  defimpl Bumblebee.HuggingFace.Transformers.Model do
    def params_mapping(_spec) do
      %{
        "feature_extractor.conv.0" => "sew.feature_extractor.conv_layers.0.conv",
        "feature_extractor.conv.1" => "sew.feature_extractor.conv_layers.1.conv",
        "feature_extractor.conv.2" => "sew.feature_extractor.conv_layers.2.conv",
        "feature_extractor.conv.3" => "sew.feature_extractor.conv_layers.3.conv",
        "feature_extractor.conv.4" => "sew.feature_extractor.conv_layers.4.conv",
        "feature_extractor.conv.5" => "sew.feature_extractor.conv_layers.5.conv",
        "feature_extractor.conv.6" => "sew.feature_extractor.conv_layers.6.conv",
        "feature_extractor.layer_norm" =>
          "sew.feature_extractor.conv_layers.0.layer_norm",
        "feature_projection.norm" => "sew.feature_projection.layer_norm",
        "feature_projection.projection" => "sew.feature_projection.projection",
        "encoder.pos_conv.norm" => "sew.encoder.layer_norm",
        "encoder.blocks.{n}.self_attention.query" =>
          "sew.encoder.layers.{n}.attention.q_proj",
        "encoder.blocks.{n}.self_attention.key" =>
          "sew.encoder.layers.{n}.attention.k_proj",
        "encoder.blocks.{n}.self_attention.value" =>
          "sew.encoder.layers.{n}.attention.v_proj",
        "encoder.blocks.{n}.self_attention.output" =>
          "sew.encoder.layers.{n}.attention.out_proj",
        "encoder.blocks.{n}.self_attention_norm" =>
          "sew.encoder.layers.{n}.layer_norm",
        "encoder.blocks.{n}.ffn.intermediate" =>
          "sew.encoder.layers.{n}.feed_forward.intermediate_dense",
        "encoder.blocks.{n}.ffn.output" =>
          "sew.encoder.layers.{n}.feed_forward.output_dense",
        "encoder.blocks.{n}.output_norm" =>
          "sew.encoder.layers.{n}.final_layer_norm",
