defmodule Bumblebee.Text.DeepseekV2 do
  ...
  ## Architectures
    ...
    * `:base` - plain DeepSeek-V2 without any head on top

    * `:for_causal_language_modeling` - DeepSeek-V2 with a language modeling
      head. The head returns logits for each token in the original
      sequence

    * `:for_sequence_classification` - DeepSeek-V2 with a sequence
  ...
  multi-head attention. This allows loading DeepSeek-V2/V3 weights with the
  ...
  dense FFN layer. This allows loading weights by mapping from expert 0 but does
  not implement the full sparse MoE routing.
  """
