defmodule Bumblebee.Text.InternLm2 do
  ...
  options =
    [
      ...
      use_bias: [
        default: false,
        doc: "whether to use bias in attention and dense layers"
      ],
      layer_norm_epsilon: [
        default: 1.0e-5,
  ...
  ## Architectures
    ...
    * `:base` - plain InternLM2 without any head on top

    * `:for_causal_language_modeling` - InternLM2 with a language modeling
      head. The head returns logits for each token in the original
      sequence

    * `:for_sequence_classification` - InternLM2 with a sequence
