defmodule Bumblebee.Text.Qwen2 do
  ...
  options =
    [
      ...
      attention_window_size: [
        default: nil,
        doc: "window size for sliding window attention"
      ],
      use_attention_bias: [
        default: true,
        doc: "whether to use bias in attention QKV projections"
      ],
      layer_norm_epsilon: [
        default: 1.0e-6,
      ...
      Shared.token_options(pad_token_id: 151643)
  ...
  ## Architectures
    ...
    * `:for_token_classification` - Qwen2 with a token classification
      head. The head returns logits for each token in the original
      sequence
    ...
    def load(spec, data) do
      ...
      opts =
        convert!(data,
          ...
          use_attention_bias: {"attention_bias", optional(boolean())},
