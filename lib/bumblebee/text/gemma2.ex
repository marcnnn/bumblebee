defmodule Bumblebee.Text.Gemma2 do
  ...
  options =
    [
      ...
      sliding_window: [
        default: 4096,
        doc: "the sliding window size for local attention on alternating layers"
      ],
      attn_logit_softcapping: [
        default: nil,
        doc: "soft-capping value for attention logits"
      ],
      use_attention_bias: [
        default: false,
        doc:
  ...
  ## Architectures
    ...
    * `:base` - plain Gemma 2 without any head on top

    * `:for_causal_language_modeling` - Gemma 2 with a language modeling
      head. The head returns logits for each token in the original
      sequence

    * `:for_sequence_classification` - Gemma 2 with a sequence
    ...
    def load(spec, data) do
      ...
      opts =
        convert!(data,
          ...
          attn_logit_softcapping: {"attn_logit_softcapping", optional(number())},
