defmodule Bumblebee.Text.Cohere do
  ...
  options =
    [
      ...
      use_qk_norm: [
        default: false,
        doc: "whether to apply layer normalization to query and key projections"
      ],
      layer_norm_epsilon: [
        default: 1.0e-5,
  ...
  @moduledoc """
  Cohere Command-R model family.

  ## Architectures

    * `:base` - plain Cohere without any head on top

    * `:for_causal_language_modeling` - Cohere with a language modeling
    ...
    def load(spec, data) do
      ...
      opts =
        convert!(data,
          ...
          use_qk_norm: {"use_qk_norm", boolean()},
