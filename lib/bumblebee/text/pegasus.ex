defmodule Bumblebee.Text.Pegasus do
  ...
  @moduledoc """
  Pegasus model family.

  ## Architectures

    * `:base` - plain Pegasus without any head on top

    * `:for_conditional_generation` - Pegasus with a language modeling
  ...
  ## References
    ...
    * [PEGASUS: Pre-training with Extracted Gap-sentences for Abstractive Summarization](https://arxiv.org/abs/1912.11613)
