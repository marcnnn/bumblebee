defmodule Bumblebee.Text.Yi do
  ...
  ## Architectures
    ...
    * `:base` - plain Yi without any head on top

    * `:for_causal_language_modeling` - Yi with a language modeling
      head. The head returns logits for each token in the original
      sequence

    * `:for_sequence_classification` - Yi with a sequence
