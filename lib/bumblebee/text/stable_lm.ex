defmodule Bumblebee.Text.StableLm do
  ...
  ## Architectures
    ...
    * `:base` - plain StableLM without any head on top

    * `:for_causal_language_modeling` - StableLM with a language modeling
      head. The head returns logits for each token in the original
      sequence

    * `:for_sequence_classification` - StableLM with a sequence
