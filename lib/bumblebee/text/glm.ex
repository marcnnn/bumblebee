defmodule Bumblebee.Text.Glm do
  ...
  options =
    [
      ...
      Shared.token_options(pad_token_id: 151329)
  ...
  ## Architectures
    ...
    * `:base` - plain GLM without any head on top

    * `:for_causal_language_modeling` - GLM with a language modeling
      head. The head returns logits for each token in the original
      sequence

    * `:for_sequence_classification` - GLM with a sequence
    ...
    def load(spec, data) do
      ...
      opts =
        convert!(data,
          ...
          use_qkv_bias: {"attention_bias", optional(boolean())},
