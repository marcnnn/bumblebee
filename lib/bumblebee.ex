defmodule Bumblebee do
  ...
  @transformers_class_to_model %{
    ...
    "BarkModel" => {Bumblebee.Audio.Bark, :base},
    "BarkForCausalLM" => {Bumblebee.Audio.Bark, :for_causal_language_modeling},
    ...
    "BloomModel" => {Bumblebee.Text.Bloom, :base},
    "BloomForCausalLM" => {Bumblebee.Text.Bloom, :for_causal_language_modeling},
    "BloomForSequenceClassification" => {Bumblebee.Text.Bloom, :for_sequence_classification},
    "BloomForTokenClassification" => {Bumblebee.Text.Bloom, :for_token_classification},
    "BlipForConditionalGeneration" => {Bumblebee.Multimodal.Blip, :for_conditional_generation},
    "Blip2ForConditionalGeneration" =>
      {Bumblebee.Multimodal.Blip2, :for_conditional_generation},
    ...
    "CodeGenModel" => {Bumblebee.Text.CodeGen, :base},
    "CodeGenForCausalLM" => {Bumblebee.Text.CodeGen, :for_causal_language_modeling},
    "CohereModel" => {Bumblebee.Text.Cohere, :base},
    "CohereForCausalLM" => {Bumblebee.Text.Cohere, :for_causal_language_modeling},
    ...
    "DaViTModel" => {Bumblebee.Vision.Davit, :base},
    "DaViTForImageClassification" => {Bumblebee.Vision.Davit, :for_image_classification},
    ...
    "DeepseekV2Model" => {Bumblebee.Text.DeepseekV2, :base},
    "DeepseekV2ForCausalLM" => {Bumblebee.Text.DeepseekV2, :for_causal_language_modeling},
    "DeepseekV2ForSequenceClassification" =>
      {Bumblebee.Text.DeepseekV2, :for_sequence_classification},
    "DeepseekV3Model" => {Bumblebee.Text.DeepseekV2, :base},
    "DeepseekV3ForCausalLM" => {Bumblebee.Text.DeepseekV2, :for_causal_language_modeling},
    ...
    "DebertaModel" => {Bumblebee.Text.Deberta, :base},
    "DebertaForMaskedLM" => {Bumblebee.Text.Deberta, :for_masked_language_modeling},
    "DebertaForSequenceClassification" =>
      {Bumblebee.Text.Deberta, :for_sequence_classification},
    "DebertaForTokenClassification" => {Bumblebee.Text.Deberta, :for_token_classification},
    "DebertaForQuestionAnswering" => {Bumblebee.Text.Deberta, :for_question_answering},
    "DebertaV2Model" => {Bumblebee.Text.DebertaV2, :base},
    "DebertaV2ForMaskedLM" => {Bumblebee.Text.DebertaV2, :for_masked_language_modeling},
    "DebertaV2ForSequenceClassification" =>
      {Bumblebee.Text.DebertaV2, :for_sequence_classification},
    "DebertaV2ForTokenClassification" => {Bumblebee.Text.DebertaV2, :for_token_classification},
    "DebertaV2ForQuestionAnswering" => {Bumblebee.Text.DebertaV2, :for_question_answering},
    "DebertaV2ForMultipleChoice" => {Bumblebee.Text.DebertaV2, :for_multiple_choice},
    "EncodecModel" => {Bumblebee.Audio.Encodec, :base},
    "EfficientNetModel" => {Bumblebee.Vision.EfficientNet, :base},
    "EfficientNetForImageClassification" =>
      {Bumblebee.Vision.EfficientNet, :for_image_classification},
    "ElectraModel" => {Bumblebee.Text.Electra, :base},
    "ElectraForMaskedLM" => {Bumblebee.Text.Electra, :for_masked_language_modeling},
    "ElectraForSequenceClassification" =>
      {Bumblebee.Text.Electra, :for_sequence_classification},
    "ElectraForTokenClassification" => {Bumblebee.Text.Electra, :for_token_classification},
    "ElectraForQuestionAnswering" => {Bumblebee.Text.Electra, :for_question_answering},
    "ElectraForMultipleChoice" => {Bumblebee.Text.Electra, :for_multiple_choice},
    "ElectraForPreTraining" => {Bumblebee.Text.Electra, :for_pre_training},
    "FalconModel" => {Bumblebee.Text.Falcon, :base},
    "FalconH1Model" => {Bumblebee.Text.FalconH1, :base},
    "FalconH1ForCausalLM" => {Bumblebee.Text.FalconH1, :for_causal_language_modeling},
    "Florence2ForConditionalGeneration" =>
      {Bumblebee.Multimodal.Florence2, :for_conditional_generation},
    "FunnelBaseModel" => {Bumblebee.Text.FunnelTransformer, :base},
    "FunnelModel" => {Bumblebee.Text.FunnelTransformer, :base},
    "FunnelForMaskedLM" => {Bumblebee.Text.FunnelTransformer, :for_masked_language_modeling},
    "FunnelForSequenceClassification" =>
      {Bumblebee.Text.FunnelTransformer, :for_sequence_classification},
    "FunnelForTokenClassification" =>
      {Bumblebee.Text.FunnelTransformer, :for_token_classification},
    "FunnelForQuestionAnswering" =>
      {Bumblebee.Text.FunnelTransformer, :for_question_answering},
    "FunnelForMultipleChoice" =>
      {Bumblebee.Text.FunnelTransformer, :for_multiple_choice},
    "FalconForCausalLM" => {Bumblebee.Text.Falcon, :for_causal_language_modeling},
    "FalconForSequenceClassification" =>
      {Bumblebee.Text.Falcon, :for_sequence_classification},
    "FalconForTokenClassification" => {Bumblebee.Text.Falcon, :for_token_classification},
    ...
    "Gemma2Model" => {Bumblebee.Text.Gemma2, :base},
    "Gemma2ForCausalLM" => {Bumblebee.Text.Gemma2, :for_causal_language_modeling},
    "Gemma2ForSequenceClassification" => {Bumblebee.Text.Gemma2, :for_sequence_classification},
    "Gemma4TextModel" => {Bumblebee.Text.Gemma4, :base},
    "Gemma4ForCausalLM" => {Bumblebee.Text.Gemma4, :for_causal_language_modeling},
    "Gemma4ForSequenceClassification" => {Bumblebee.Text.Gemma4, :for_sequence_classification},
    "GlmModel" => {Bumblebee.Text.Glm, :base},
    "GlmForCausalLM" => {Bumblebee.Text.Glm, :for_causal_language_modeling},
    "GlmForSequenceClassification" => {Bumblebee.Text.Glm, :for_sequence_classification},
    "Glm4Model" => {Bumblebee.Text.Glm, :base},
    "Glm4ForCausalLM" => {Bumblebee.Text.Glm, :for_causal_language_modeling},
    "Glm4ForSequenceClassification" => {Bumblebee.Text.Glm, :for_sequence_classification},
    ...
    "GPTJModel" => {Bumblebee.Text.GptJ, :base},
    "GPTJForCausalLM" => {Bumblebee.Text.GptJ, :for_causal_language_modeling},
    "GPTJForSequenceClassification" => {Bumblebee.Text.GptJ, :for_sequence_classification},
    "GPTJForQuestionAnswering" => {Bumblebee.Text.GptJ, :for_question_answering},
    "GPTNeoModel" => {Bumblebee.Text.GptNeo, :base},
    "GPTNeoForCausalLM" => {Bumblebee.Text.GptNeo, :for_causal_language_modeling},
    "GPTNeoForSequenceClassification" => {Bumblebee.Text.GptNeo, :for_sequence_classification},
    "GPTNeoForTokenClassification" => {Bumblebee.Text.GptNeo, :for_token_classification},
    ...
    "HubertModel" => {Bumblebee.Audio.Hubert, :base},
    "HubertForCTC" => {Bumblebee.Audio.Hubert, :for_ctc},
    "HubertForSequenceClassification" =>
      {Bumblebee.Audio.Hubert, :for_sequence_classification},
    "InternLM2Model" => {Bumblebee.Text.InternLm2, :base},
    "InternLM2ForCausalLM" => {Bumblebee.Text.InternLm2, :for_causal_language_modeling},
    "InternLM2ForSequenceClassification" =>
      {Bumblebee.Text.InternLm2, :for_sequence_classification},
    "InternVLChatModel" =>
    ...
    "LlavaForConditionalGeneration" =>
      {Bumblebee.Multimodal.Llava, :for_conditional_generation},
    "LongformerModel" => {Bumblebee.Text.Longformer, :base},
    "LongformerForMaskedLM" => {Bumblebee.Text.Longformer, :for_masked_language_modeling},
    "LongformerForSequenceClassification" =>
      {Bumblebee.Text.Longformer, :for_sequence_classification},
    "LongformerForTokenClassification" =>
      {Bumblebee.Text.Longformer, :for_token_classification},
    "LongformerForQuestionAnswering" =>
      {Bumblebee.Text.Longformer, :for_question_answering},
    "LongformerForMultipleChoice" =>
      {Bumblebee.Text.Longformer, :for_multiple_choice},
    "MarianModel" => {Bumblebee.Text.Marian, :base},
    "MarianMTModel" => {Bumblebee.Text.Marian, :for_conditional_generation},
    ...
    "MusicgenModel" => {Bumblebee.Audio.MusicGen, :base},
    "MusicgenForConditionalGeneration" =>
      {Bumblebee.Audio.MusicGen, :for_conditional_generation},
    "MambaModel" => {Bumblebee.Text.Mamba, :base},
    "MambaForCausalLM" => {Bumblebee.Text.Mamba, :for_causal_language_modeling},
    "MistralModel" => {Bumblebee.Text.Mistral, :base},
    "MixtralModel" => {Bumblebee.Text.Mixtral, :base},
    "MixtralForCausalLM" => {Bumblebee.Text.Mixtral, :for_causal_language_modeling},
    "MixtralForSequenceClassification" =>
      {Bumblebee.Text.Mixtral, :for_sequence_classification},
    "MoondreamForConditionalGeneration" =>
      {Bumblebee.Multimodal.Moondream, :for_conditional_generation},
    "OPTModel" => {Bumblebee.Text.Opt, :base},
    "OPTForCausalLM" => {Bumblebee.Text.Opt, :for_causal_language_modeling},
    "OPTForSequenceClassification" => {Bumblebee.Text.Opt, :for_sequence_classification},
    "OPTForQuestionAnswering" => {Bumblebee.Text.Opt, :for_question_answering},
    ...
    "OlmoModel" => {Bumblebee.Text.Olmo, :base},
    "OlmoForCausalLM" => {Bumblebee.Text.Olmo, :for_causal_language_modeling},
    "PegasusModel" => {Bumblebee.Text.Pegasus, :base},
    "PegasusForConditionalGeneration" =>
      {Bumblebee.Text.Pegasus, :for_conditional_generation},
    "PhiModel" => {Bumblebee.Text.Phi, :base},
    "Qwen2Model" => {Bumblebee.Text.Qwen2, :base},
    "Qwen2ForCausalLM" => {Bumblebee.Text.Qwen2, :for_causal_language_modeling},
    "Qwen2ForSequenceClassification" => {Bumblebee.Text.Qwen2, :for_sequence_classification},
    "Qwen2ForTokenClassification" => {Bumblebee.Text.Qwen2, :for_token_classification},
    "Qwen2VLForConditionalGeneration" =>
      {Bumblebee.Multimodal.Qwen2Vl, :for_conditional_generation},
    ...
    "RoFormerForMaskedLM" => {Bumblebee.Text.Roformer, :for_masked_language_modeling},
    "RoFormerForSequenceClassification" =>
      {Bumblebee.Text.Roformer, :for_sequence_classification},
    "RoFormerForTokenClassification" => {Bumblebee.Text.Roformer, :for_token_classification},
    "RoFormerForQuestionAnswering" => {Bumblebee.Text.Roformer, :for_question_answering},
    "RoFormerForMultipleChoice" => {Bumblebee.Text.Roformer, :for_multiple_choice},
    ...
    "MobileViTModel" => {Bumblebee.Vision.MobileVit, :base},
    "MobileViTForImageClassification" =>
      {Bumblebee.Vision.MobileVit, :for_image_classification},
    "SegformerModel" => {Bumblebee.Vision.Segformer, :base},
    "SegformerForImageClassification" =>
      {Bumblebee.Vision.Segformer, :for_image_classification},
    "SegformerForSemanticSegmentation" =>
      {Bumblebee.Vision.Segformer, :for_semantic_segmentation},
    "SEWModel" => {Bumblebee.Audio.Sew, :base},
    "SEWForCTC" => {Bumblebee.Audio.Sew, :for_ctc},
    "SEWForSequenceClassification" =>
      {Bumblebee.Audio.Sew, :for_sequence_classification},
    "SpeechT5Model" => {Bumblebee.Audio.SpeechT5, :base},
    "SpeechT5ForSpeechToText" => {Bumblebee.Audio.SpeechT5, :for_speech_to_text},
    "SpeechT5ForTextToSpeech" => {Bumblebee.Audio.SpeechT5, :for_text_to_speech},
    "StableLmModel" => {Bumblebee.Text.StableLm, :base},
    "StableLmForCausalLM" => {Bumblebee.Text.StableLm, :for_causal_language_modeling},
    "StableLmForSequenceClassification" =>
      {Bumblebee.Text.StableLm, :for_sequence_classification},
    "Starcoder2Model" => {Bumblebee.Text.StarCoder2, :base},
    "Starcoder2ForCausalLM" => {Bumblebee.Text.StarCoder2, :for_causal_language_modeling},
    "Starcoder2ForSequenceClassification" =>
      {Bumblebee.Text.StarCoder2, :for_sequence_classification},
    "Starcoder2ForTokenClassification" =>
      {Bumblebee.Text.StarCoder2, :for_token_classification},
    "SwinModel" => {Bumblebee.Vision.Swin, :base},
    "SwinForImageClassification" => {Bumblebee.Vision.Swin, :for_image_classification},
    "Swinv2Model" => {Bumblebee.Vision.SwinV2, :base},
    "Swinv2ForImageClassification" => {Bumblebee.Vision.SwinV2, :for_image_classification},
    "Mask2FormerModel" => {Bumblebee.Vision.Mask2Former, :base},
    "Mask2FormerForUniversalSegmentation" =>
      {Bumblebee.Vision.Mask2Former, :for_instance_segmentation},
    "PvtV2Model" => {Bumblebee.Vision.Pvt, :base},
    "PvtV2ForImageClassification" => {Bumblebee.Vision.Pvt, :for_image_classification},
    "SamModel" => {Bumblebee.Vision.Sam, :base},
    "SiglipVisionModel" => {Bumblebee.Vision.SiglipVision, :base},
    "Qwen2VLVisionModel" => {Bumblebee.Vision.Qwen2VlVision, :base},
    ...
    "WavLMModel" => {Bumblebee.Audio.WavLm, :base},
    "WavLMForCTC" => {Bumblebee.Audio.WavLm, :for_ctc},
    "WavLMForSequenceClassification" =>
      {Bumblebee.Audio.WavLm, :for_sequence_classification},
    "Wav2Vec2Model" => {Bumblebee.Audio.Wav2Vec2, :base},
    "Wav2Vec2ForCTC" => {Bumblebee.Audio.Wav2Vec2, :for_ctc},
    "Wav2Vec2ForSequenceClassification" =>
      {Bumblebee.Audio.Wav2Vec2, :for_sequence_classification},
    ...
    "XLNetModel" => {Bumblebee.Text.Xlnet, :base},
    "XLNetForSequenceClassification" => {Bumblebee.Text.Xlnet, :for_sequence_classification},
    "XLNetForTokenClassification" => {Bumblebee.Text.Xlnet, :for_token_classification},
    "XLNetForQuestionAnswering" => {Bumblebee.Text.Xlnet, :for_question_answering},
    "XLNetForMultipleChoice" => {Bumblebee.Text.Xlnet, :for_multiple_choice},
  ...
  @model_type_to_featurizer %{
    ...
    "llava" => Bumblebee.Vision.ClipFeaturizer,
    "moondream" => Bumblebee.Vision.VitFeaturizer,
    "qwen2_vl" => Bumblebee.Vision.VitFeaturizer,
    "intern_vl" => Bumblebee.Vision.VitFeaturizer,
    "florence2" => Bumblebee.Vision.ConvNextFeaturizer,
    "blip-2" => Bumblebee.Vision.BlipFeaturizer,
    "davit" => Bumblebee.Vision.ConvNextFeaturizer,
